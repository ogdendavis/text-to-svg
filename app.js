...
const getLetterPoints = (l,x,y) => {
  const lookup = {
    ...
    ';': `${x},${y+1} ${x+1},${y+1} ${x+1},${y+2} ${x},${y+2} ${x},${y+5} ${x+1},${y+5} ${x+1},${y+3} ${x},${y+3} ${x},${y+1}`,
    ',': `${x},${y}, ${x+1},${y} ${x+1},${y+2} ${x},${y+2}`,
    '-': `${x},${y} ${x+3},${y} ${x+3},${y+1} ${x},${y+1}`,
    '(': `${x+2},${y} ${x+2},${y+1} ${x},${y+1} ${x},${y+4} ${x+2},${y+4} ${x+2},${y+5} ${x+1},${y+5} ${x+1},${y}`,
    ')': `${x},${y} ${x+1},${y} ${x+1},${y+5} ${x},${y+5} ${x},${y+4} ${x+2},${y+4} ${x+2},${y+1} ${x},${y+1}`,
    '\'': `${x},${y} ${x+1},${y} ${x+1},${y+2} ${x},${y+2}`,
